...
public class Encryption {
	...
	public void encrypt(Character letter) {
		...
		// Get current letter from alphabet array and get corresponding
		// reflection and it's index
	...
	public void rotationSequence() {

		r1.rotateRotor();

		if (r1.getRotorCounter() == 27) {
			r2.rotateRotor();
			r1.resetRotorCounter();

			if (r2.getRotorCounter() == 27) {
				r3.rotateRotor();
				r2.resetRotorCounter();

				if (r3.getRotorCounter() == 27) {
					r3.resetRotorCounter();
				}
			}
		}
